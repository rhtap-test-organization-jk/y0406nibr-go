...
export IMAGE_URL=${IMAGE_URL-tssc-quay-quay-tssc-quay.apps.cluster-lsl2n.lsl2n.sandbox1297.opentlc.com/tssc/rhtap-qe-go:$CI_TYPE-$TAG}
...
export GITOPS_REPO_URL=https://github.com/rhtap-test-organization-jk/y0406nibr-go-gitops
...
export REKOR_HOST=${REKOR_HOST-https://rekor-server-tssc-tas.apps.cluster-lsl2n.lsl2n.sandbox1297.opentlc.com}
...
export TUF_MIRROR=${TUF_MIRROR-https://tuf-tssc-tas.apps.cluster-lsl2n.lsl2n.sandbox1297.opentlc.com}
...
export COSIGN_PUBLIC_KEY=LS0tLS1CRUdJTiBQVUJMSUMgS0VZLS0tLS0KTUZrd0V3WUhLb1pJemowQ0FRWUlLb1pJemowREFRY0RRZ0FFZnhpSmk2ZHVZMW1tMG4vSFArQU5PYWNLdlN4VwoxZzdtRFFSV1hyckNVdmIzWFFhV1VpMXM4TGlsN1R5eGp0S3lYdmY3YllqT1poUlhHWEIwM1k5L2pBPT0KLS0tLS1FTkQgUFVCTElDIEtFWS0tLS0tCg==
